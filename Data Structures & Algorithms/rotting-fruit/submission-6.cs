public class Solution {
    ...
    public int ComputeMinTime(int[][] grid, Queue<(int, int)> queue, int freshCount)
    {
        ...
        if (freshCount == 0) return 0; // important learning : I missed this edge case on initial submission
        else if (rottenCount == 0) return -1; // important learning: I missed this edge case on initial submission
