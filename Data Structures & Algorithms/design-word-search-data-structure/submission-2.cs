...
// I will build a prefix tree and keep it updated as new words get added.
// Core challenge - how to proceed further when encountering a .
// I can store the characters at each level in a Dictionary maintains a mapping to parent.
// On encountering a dot, I will check in the dictionary of next level whether the character exists and get its parent

// on encountering a . I can initiate DFS iterating through all the nodes at that level and explore all the tree paths for the word