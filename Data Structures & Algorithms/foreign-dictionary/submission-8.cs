public class Solution {
    ...
    public string foreignDictionary(string[] words) {
        ...
        foreach(string word in words)
        {
            ...
            if (prevWord.StartsWith(word) && prevWord.Length > word.Length) return string.Empty;
            prevWord = word;
        }

        ExtractAndMapEdges(words, incomingEdges, outDegree);
        return TopologicalOrdering(incomingEdges, outDegree);       
    }

    public void ExtractAndMapEdges(
        string[] words,
