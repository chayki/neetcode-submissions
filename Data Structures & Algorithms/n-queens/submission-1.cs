public class Solution {
    ...
    private Dictionary<int,char[]> rowFormation = new();
    ...
    {
        var list = new List<string>(rowFormation.Count);
        for(int i = 0; i < rowFormation.Count; ++i)
        {
